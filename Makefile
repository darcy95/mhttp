...
SRCS=http_parser.c mpsock_pool.c mpsock_connection.c mpsock_socket.c mpsock_collector.c mpsock_interface.c mpsock_dns.c mpsock_buffer.c mpsock_scheduler.c mpsock_scheduler_minimum_throughput_assurance.c mpsock_scheduler_algorithms.c
...
$(LIB).so: $(LIB).o
	...
	$(AR) cru $(LIBDIR)/$(LIB).a $(LIB).o
	ranlib $(LIBDIR)/$(LIB).a

$(LIB).o: $(LIB).c mpsock_tcp.h mpsock_misc.h uthash.h $(OBJ)
